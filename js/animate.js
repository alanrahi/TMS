...
//Add animation -add
  $('.add').on('click',function(){
    $('.instances').addClass('animated flip').mouseleave('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend', function(){
...
//body animation 
  $('.nav-li').on('click', function(){
    $('body').addClass('animated flip').mouseleave('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend', function(){
       $(this).removeClass('animated flip')
       console.log('okay, it worked')
    });
